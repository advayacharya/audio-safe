...
downloads_dir = os.path.join(static_dir, 'downloads') # New downloads folder
...
def cleanup_old_files():
    """Deletes files in downloads folder to save space (Keep only last 5 files)"""
    try:
...
def encode_text():
    ...
    try:
        ...
        # 4. Save to STATIC/DOWNLOADS folder (Disk)
        ...
        # 6. REDIRECT to static file (Server handles download fast)
        # Note: We use _external=True to give a full URL
